...
CREATE TABLE IF NOT EXISTS batches (
    ...
    provenance_model VARCHAR(32) DEFAULT 'COMPANY_MANAGED', -- DIRECT_BEEKEEPER, COMPANY_MANAGED
    company_id VARCHAR(64) REFERENCES organizations(id) ON DELETE SET NULL,
