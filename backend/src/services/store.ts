...
export const memoryStore = {
  ...
  batches: new Map<string, Batch>([
    ['HC-2026-0001', {
      ...
      companyId: 'ORG-PACK-01',
      companyName: 'PureFlora Packaging & Bottling Hub',
    ...
    ['HC-2026-0002', {
      id: 'HC-2026-0002',
      provenanceModel: 'COMPANY_MANAGED',
      companyId: 'ORG-PROC-01',
      companyName: 'Nilgiri Pure Extraction Ltd',
    ...
    ['HC-2026-0010', {
      ...
      hiveId: 'HIVE-010',
      beekeeperId: 'BK-005',
      beekeeperName: 'Subhas Mondal (Sundarbans Apiarist)',
      quantity: 22.5,
      origin: 'Sundarbans Wild Apiary Zone #1 (HIVE-010)',
      floralSource: 'Mangrove Wildflower Honey',
      status: 'VERIFIED',
