    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-stone-200/80 pb-5">
        ...
        <div className="flex items-center space-x-3">
          <button
            ...
            className="bg-[#3D5A3A] hover:bg-[#2E4A2E] text-white px-5 py-2.5 rounded-full text-xs font-semibold flex items-center space-x-2 transition shadow-xs cursor-pointer"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="panel-card p-5 flex items-center justify-between">
          ...
          <div className="p-3 bg-forest-50 rounded-xl text-[#3D5A3A] border border-forest-200 shadow-xs">
        ...
        <div className="lg:col-span-2 panel-card p-6 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="text-xs text-[#3D5A3A] hover:text-[#2E4A2E] hover:underline flex items-center font-semibold"
            >
        ...
        <div className="panel-card p-6 space-y-4">
          ...
          <div className="space-y-3">
            {batches.map((batch) => (
              <div
                key={batch.id}
                className="p-3.5 bg-stone-50/70 rounded-xl border border-stone-200 flex items-center justify-between hover:border-forest-300 hover:bg-forest-50/30 transition shadow-2xs"
              >
                <div onClick={() => onNavigate(`batch-${batch.id}`)} className="cursor-pointer">
                  <p className="font-mono text-xs text-stone-900 font-bold">{batch.id}</p>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    ...
                    className="p-1.5 bg-white hover:bg-forest-50 text-stone-600 hover:text-[#3D5A3A] rounded-full border border-stone-200 transition shadow-2xs cursor-pointer"
